...
function promptLooksResearchRelated(prompt) {
  return /\b(obsidian|zotero|paper|papers|literature|review|experiment|results?|finding|analysis|research|plan|todo|daily|meeting|writing|draft|proposal|rebuttal|claim|method)\b/i.test(prompt);
}
