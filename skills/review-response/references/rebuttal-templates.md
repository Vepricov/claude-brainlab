...
**Changes**: [Specific changes made and location]
...
### Template 2: Emphasizing Improvements
...
### Template 3: Highlighting Key Points
...
```
We thank the reviewer for this valuable suggestion. We have [specific revision]. [Location of change].
```

**Template 2: Accept and Expand**
```
We appreciate this insightful comment. We agree that [issue description] is important. We have [specific revision 1] and [specific revision 2]. These changes are reflected in [location 1] and [location 2].
```

**Template 3: Accept Typos/Formatting Errors**
```
...
```
We thank the reviewer for this suggestion. While [suggested method] has advantages in [scenario A], we chose [our method] because [reason 1] and [reason 2]. Our preliminary experiments showed that [experimental result]. We have added this discussion to [location].
```

**Template 3: Technical Constraints**
```
...
**Template 2: Pointing to Existing Content**
```
We appreciate this comment. We would like to note that we did [completed work] in our study. Specifically, [detailed description]. These results are presented in [location]. To make this more prominent, we have [improvements].
```

**Template 3: Acknowledging Unclear Wording**
```
...
**Template 1: Completed Experiments**
```
...
**Template 2: Committing to Experiments**
```
We appreciate this valuable suggestion. We agree that [importance of experiment]. We are currently conducting [experiment content] and will include the results in the revised manuscript. We expect to complete these experiments within [time] and will update the manuscript accordingly.
```

**Template 3: Experiment Not Feasible but Providing Alternative**
```
...
**Template**:
```
We thank Reviewers [X] and [Y] for raising this important point. We agree that [issue description]. We have [specific revision]. These changes address both reviewers' concerns and are reflected in [location].
```
...
### Reviewers Have Conflicting Opinions
...
**Template**:
```
We thank the reviewer for this suggestion. While we agree that [value of suggestion], [difficulty of full implementation]. However, we have [partial implementation or alternative], which [outcome]. We acknowledge this limitation in [location] and discuss it as future work.
```
...
**Template 1: Summarizing Major Changes**
```
## Summary of Major Changes
...
**Template 2: Emphasizing New Content**
```
## Summary of Major Changes
...
These changes have improved the manuscript's [quality aspects], and we believe it now meets the high standards of [journal/conference name].
```
...
Assume comments from 3 reviewers:
...
2. **Classify comments**: Categorize each reviewer's comments as Major or Minor
3. **Choose strategy**: Select Accept/Defend/Clarify/Experiment strategy based on comment type
4. **Apply templates**: Use the corresponding strategy template to write the response
5. **Add specific content**: Fill in placeholders in the templates ([specific revision], [location], etc.)
6. **Check consistency**: Ensure tone and format are consistent across all responses
...
- Domain conferences: Adjust technical terminology based on domain characteristics

**Adjust by review round**:
- First round: More detailed explanations and more new experiments
- Second round: Focus on unresolved issues, concise and clear
- Third round: Emphasize improvements made, demonstrate cooperative attitude

### Common Errors

**Avoid**:
- Responses that are too brief ("Done" or "Fixed")
- No specific location references
- Defensive or aggressive tone
- Committing to experiments that cannot be completed
- Ignoring certain comments

**Recommended**:
- Every response includes both Response and Changes sections
- Provide specific section, page, table, figure references
- Maintain polite and professional tone
- Only commit to feasible improvements
- Respond to all comments, even small typos
